/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/Host/home/ilg/Work/riscv-none-embed-gcc-10.1.0-1.1/linux-arm64/sources/riscv-gcc-10.1.0-1.1/gcc/config/riscv/riscv.md'.  */
...
{
  if (c >= CONSTRAINT_C && c <= CONSTRAINT_vp)
    return;
